...
public class Ex06Test {
    ...
    void init(){
        ...
        member.setEmail("user01test.org");
    ...
    @Test
    void test3(){
        List<BoardData> items = boardDataRepository.findAll();//1차-boarddata로
        for(BoardData item :items){
            Member member = item.getMember();
            String email=member.getEmail();//2차-email로
        }
    }
    @Test
    void test4(){
        //List<BoardData> items = boardDataRepository.getSubjects("목:");
        List<BoardData> items = boardDataRepository
                .findBySubjectContaining("목");
    }
    @Test
    void test5(){
